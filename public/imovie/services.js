<<<<<<< HEAD:public/imovie/services.js
app.factory('MovieService', function($http){
   return{
   	  listMoviesInCinemas:function(){
   	  	 return $http.post(options.api.base_url + '/movie/in_cinemas', {});
   	  },
      listMoviesOnLaptop:function(){
      	 return $http.post(options.api.base_url + '/movie/on_laptop', {});
      },
      saveMovieInCinemas:function(movie){
      	return $http.post(options.api.base_url + '/movie/in_cinemas/save', {movie: movie });
      },
      saveMovieOnLaptop:function(movie){
      	return $http.post(options.api.base_url + '/movie/on_laptop/save', {movie: movie });
      }
   };
});
...
=======
>>>>>>> 92410207fe21e88c14eb31979514782dcc8e7724:public/javascripts/services.js
